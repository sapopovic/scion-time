...
Reference platform: Ubuntu 22.04 LTS, Go 1.23.6; see [below](https://github.com/marcfrei/scion-time/edit/main/README.md#installing-prerequisites-for-a-scion-test-environment).
...
Reference platform: Ubuntu 24.04 LTS, Go 1.23.6
...
curl -LO https://golang.org/dl/go1.23.6.linux-amd64.tar.gz
...
```
sudo rm -rf /usr/local/go
curl -LO https://golang.org/dl/go1.23.6.linux-arm64.tar.gz
echo "561c780e8f4a8955d32bf72e46af0b5ee5e0debe1e4633df9a03781878219202 go1.23.6.linux-arm64.tar.gz" | sha256sum -c
