...
Reference platform: Ubuntu 22.04 LTS, Go 1.24.0; see [below](https://github.com/marcfrei/scion-time/edit/main/README.md#installing-prerequisites-for-a-scion-test-environment).
...
Reference platform: Ubuntu 24.04 LTS, Go 1.24.0
...
```
sudo rm -rf /usr/local/go
curl -LO https://golang.org/dl/go1.24.0.linux-arm64.tar.gz
echo "c3fa6d16ffa261091a5617145553c71d21435ce547e44cc6dfb7470865527cc7 go1.24.0.linux-arm64.tar.gz" | sha256sum -c
